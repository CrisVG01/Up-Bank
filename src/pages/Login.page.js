...
const Login = () => {
  ...
  return <form style={{ display: "flex", flexDirection: "column", maxWidth: "300px", margin: "auto" }}>
    ...
    <TextField
      ...
      style={{ marginBottom: "1rem" }}
    />
    <Button id="login-button" testid="login-button" variant="contained" color="primary" onClick={onSubmit} label="LOGIN" style={{ textDecoration: "none", backgroundColor : "#570E1F" }}>
      LOGIN
    </Button>
